...
2. **Then** ask what they're trying to get done or what they want to configure. Optionally ask for draft path, publish config, or log path — but do **not** require them to introduce themselves or to name you.
