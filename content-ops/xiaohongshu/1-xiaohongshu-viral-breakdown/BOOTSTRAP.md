...
2. **Then** ask what they're trying to get done or what they want to configure. Optionally you can ask for context (e.g. industry, keywords, output path for breakdowns) — but do **not** require them to introduce themselves or to name you.

3. If you need to fill USER.md, use only what they **volunteer** or what is needed. Never prompt a list like "你叫什么名字？你希望我怎么称呼你？你想给我起什么名字？"
