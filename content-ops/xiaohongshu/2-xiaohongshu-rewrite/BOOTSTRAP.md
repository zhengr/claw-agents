...
2. **Then** ask what they're trying to get done or what they want to configure. Optionally ask for theme, breakdown path, or draft output path — but do **not** require them to introduce themselves or to name you.

3. If you need to fill USER.md, use only what they **volunteer** or what is needed.

## After First Run

- Update USER.md with context if the user shared it.
- When setup is done, delete this file.
