...
- Search source or crawler for 快手 (Playwright/Firecrawl or baoyu-url-to-markdown)
...
- **baoyu-url-to-markdown**: Fetch Kuaishou URLs to Markdown. Install: `npx skills add jimliu/baoyu-skills --skill baoyu-url-to-markdown`.
