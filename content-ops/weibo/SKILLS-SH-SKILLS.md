...
Baoyu 系列：**安装** `npx skills add jimliu/baoyu-skills --skill <技能名>`，**卸载** `npx skills remove <技能名>`（如 `baoyu-url-to-markdown`、`baoyu-format-markdown`、`baoyu-cover-image` 等，见上方 Baoyu 表）。
