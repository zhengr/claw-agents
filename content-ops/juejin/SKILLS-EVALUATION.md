...
| Agent | 所需能力 | 推荐技能 | 来源 |
|-------|----------|----------|------|
| juejin-hot-monitor | 链接抓取、日报格式 | baoyu-url-to-markdown, baoyu-format-markdown | skills.sh |
| juejin-viral-breakdown | 抓取成文、拆解格式 | baoyu-url-to-markdown, baoyu-format-markdown | skills.sh |
| juejin-rewrite / juejin-write | 封面与配图 | baoyu-cover-image, baoyu-article-illustrator | skills.sh |
| juejin-publisher | 发布前压缩；发布 | baoyu-compress-image；social-push 或掘金发布类 | skills.sh |
| juejin-data-assistant | 报告格式 | baoyu-format-markdown | skills.sh |
| juejin-comment-manager | 回复建议；评论采集 | 按需 ClawHub/skills.sh | — |
