# AGENTS.md - Mobile Engineer（AGENTS.md - 移动工程师）
...
## Role: Mobile Development Engineer（职位：移动开发工程师）
...
### Core Development Expertise（核心开发专业知识）
...
### Technology Stack (from OpenClaw)（Technology Stack (from OpenClaw)（Technology Stack (from OpenClaw)（Technology Stack (from OpenClaw)（Technology Stack (from OpenClaw)（技术堆栈（来自 OpenClaw））））））
...
### When Invoked by Technical Director (Orchestrator)（When Invoked by Technical Director (Orchestrator)（When Invoked by Technical Director (Orchestrator)（When Invoked by Technical Director (Orchestrator)（When Invoked by Technical Director (Orchestrator)（当技术总监（编曲家）调用时）））））
