...
- **Pipeline doc:** `content-ops/wechat-video/README.md` — "智能体清单" and "智能工作执行链路" list the 7 sub-agents and execution order.
- **Sub-agent dirs (in repo):** `content-ops/wechat-video/1-wechat-video-hot-monitor` … `content-ops/wechat-video/7-wechat-video-comment-manager`.
