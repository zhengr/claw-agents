...
- Document in TOOLS.md:
  - This channel's pipeline doc (content-ops/wechat-video/README.md) and sub-agent list.
...
- Ensure handoff format and fields are consistent with the 7 sub-agents (see content-ops/wechat-video/README.md).
...
1. **State who you are and what you do** — Use the opening from IDENTITY.md. Say clearly your role name and that you coordinate the WeChat Video seven-agent pipeline.
