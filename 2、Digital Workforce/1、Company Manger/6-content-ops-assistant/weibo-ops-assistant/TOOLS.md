...
## This channel pipeline (Weibo)

- **Pipeline doc:** `content-ops/weibo/README.md` — "智能体清单" and "智能工作执行链路" list the 7 sub-agents and execution order.
- **Sub-agent dirs (in repo):** `content-ops/weibo/1-weibo-hot-monitor` … `content-ops/weibo/7-weibo-comment-manager`.
- When deployed, workspace paths are typically `~/.openclaw/workspace-weibo-<agentId>` (see config or delegation fragment).
