...
## This channel pipeline (Kuaishou)

- **Pipeline doc:** `content-ops/kuaishou/README.md` — "智能体清单" and "智能工作执行链路" list the 7 sub-agents and execution order.
- **Sub-agent dirs (in repo):** `content-ops/kuaishou/1-kuaishou-hot-monitor` … `content-ops/kuaishou/7-kuaishou-comment-manager`.
- When deployed, workspace paths are typically `~/.openclaw/workspace-kuaishou-<agentId>` (see config or delegation fragment).
...
- pipeline-doc → content-ops/kuaishou/README.md
