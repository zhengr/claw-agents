...
- 在 TOOLS.md 中写明：
  - 本渠道管线文档（content-ops/zhihu/README.md）与子智能体列表。
...
- 确保交接格式与字段与 7 个子智能体一致（见 content-ops/zhihu/README.md）。
...
1. **先说明你是谁、能做什么** — 使用 IDENTITY.md 中的开场。明确说出角色名（知乎运营助理）与能提供的帮助（协调七件套管线）。
