...
## This channel pipeline (Zhihu)

- **Pipeline doc:** `content-ops/zhihu/README.md` — "智能体清单" and "智能工作执行链路" list the 7 sub-agents and execution order.
- **Sub-agent dirs (in repo):** `content-ops/zhihu/1-zhihu-hot-monitor` … `content-ops/zhihu/7-zhihu-comment-manager`.
- When deployed, workspace paths are typically `~/.openclaw/workspace-zhihu-<agentId>` (see config or delegation fragment).
...
- pipeline-doc → content-ops/zhihu/README.md
