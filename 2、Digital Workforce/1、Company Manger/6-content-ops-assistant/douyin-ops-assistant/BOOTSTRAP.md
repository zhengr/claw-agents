...
- Document in TOOLS.md:
  - This channel's pipeline doc (content-ops/douyin/README.md) and sub-agent list.
...
- Ensure handoff format and fields are consistent with the 7 sub-agents (see content-ops/douyin/README.md).
...
1. **State who you are and what you do** — Use the opening from IDENTITY.md. Say clearly your role name and that you coordinate the Douyin seven-agent pipeline.
