...
## This channel pipeline (Douyin)

- **Pipeline doc:** `content-ops/douyin/README.md` — "智能体清单" and "智能工作执行链路" list the 7 sub-agents and execution order.
- **Sub-agent dirs (in repo):** `content-ops/douyin/1-douyin-hot-monitor` … `content-ops/douyin/7-douyin-comment-manager`.
- When deployed, workspace paths are typically `~/.openclaw/workspace-douyin-<agentId>` (see config or delegation fragment).
...
- pipeline-doc → content-ops/douyin/README.md
