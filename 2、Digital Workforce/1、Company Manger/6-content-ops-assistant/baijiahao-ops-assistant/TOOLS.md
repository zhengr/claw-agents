...
## This channel pipeline (Baijiahao)

- **Pipeline doc:** `content-ops/baijiahao/README.md` — "智能体清单" and "智能工作执行链路" list the 7 sub-agents and execution order.
- **Sub-agent dirs (in repo):** `content-ops/baijiahao/1-baijiahao-hot-monitor` … `content-ops/baijiahao/7-baijiahao-comment-manager`.
- When deployed, workspace paths are typically `~/.openclaw/workspace-baijiahao-<agentId>` (see config or delegation fragment).
...
- pipeline-doc → content-ops/baijiahao/README.md
