...
## This channel pipeline (Toutiao)

- **Pipeline doc:** `content-ops/toutiao/README.md` — "智能体清单" and "智能工作执行链路" list the 7 sub-agents and execution order.
- **Sub-agent dirs (in repo):** `content-ops/toutiao/1-toutiao-hot-monitor` … `content-ops/toutiao/7-toutiao-comment-manager`.
- When deployed, workspace paths are typically `~/.openclaw/workspace-toutiao-<agentId>` (see config or delegation fragment).
...
- pipeline-doc → content-ops/toutiao/README.md
