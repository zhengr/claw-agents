...
- `AGENTS.zh-CN.md` — **中文**，与 AGENTS.md 内容等价，供团队阅读
- `SOUL.md` — 人格与风格、底线（建议同步提供 SOUL.zh-CN.md）
...
- `IDENTITY.zh-CN.md` — **中文**，我是谁？+ 职责/何时调用/专长/产出，与 IDENTITY.md 对应；模板见 [docs/IDENTITY-template.zh-CN.md](../docs/IDENTITY-template.zh-CN.md)
...
- `HEARTBEAT.zh-CN.md` — 心跳任务说明（中文对照）

**中英文约定：** 所有智能体配置提供**中英文两个独立版本**：`AGENTS.md` / `AGENTS.zh-CN.md`，`IDENTITY.md` / `IDENTITY.zh-CN.md`，`HEARTBEAT.md` / `HEARTBEAT.zh-CN.md`。模板与启发见 [docs/AGENTS-template-inspiration](../docs/AGENTS-template-inspiration.md)、[docs/IDENTITY-template](../docs/IDENTITY-template.md)、[docs/HEARTBEAT-template](../docs/HEARTBEAT-template.md) 及对应 `.zh-CN.md`。
