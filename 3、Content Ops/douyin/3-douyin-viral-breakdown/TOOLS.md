...
- Search source or crawler for 抖音 (Playwright/Firecrawl or baoyu-url-to-markdown)
...
- **baoyu-url-to-markdown**: Fetch Douyin URLs to Markdown. Install: `npx skills add jimliu/baoyu-skills --skill baoyu-url-to-markdown`.
