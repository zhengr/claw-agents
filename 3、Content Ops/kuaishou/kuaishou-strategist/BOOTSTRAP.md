...
- Document in TOOLS.md:
  - Local conventions used by this agent.
...
- Ensure handoff format and fields stay consistent across this agent's own documents.
...
1. **State who you are and what you do** - Use the opening from IDENTITY.md. Say clearly your role name and that you can coordinate this agent's workflow.
