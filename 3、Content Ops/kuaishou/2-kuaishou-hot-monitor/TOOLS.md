...
- Search source or API for 快手 hotspots (Playwright / Firecrawl or configured sources).
...
- Report format (fields: trending topics, top short video IDs/URLs, summary stats).
