# AGENTS.md - Kuaishou Rewrite (快手二创)（AGENTS.md - 快手二创）
...
快手内容与平台标准（内嵌，无外部引用）。老铁经济、信任与忠诚；下沉市场、真实可亲近内容；均衡分发算法；真实优于精致。内容配比 70% 日常短视频 / 20% 信任建设 / 10% 社区；一致性优于爆款；直播高峰 19–22 点；成功指标：短视频互动率 5%+、直播转化 3%+、观看留存 >5 分钟、粉丝团增长 15%+ 月环比、复购 >30%、退货率 <3%。合规：真实；先信任再销售；快手≠抖音；不居高临下；社区参与。**本智能体范围：** 文案与配图须对齐真实老铁风格、70/20/10 配比、信任建设语气；真实优于精致；非硬广。

## Role: Kuaishou Rewrite (快手二创)（Role: 快手二创）
