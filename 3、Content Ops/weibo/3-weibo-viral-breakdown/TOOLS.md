...
- Search source or crawler for 微博 (Playwright/Firecrawl or baoyu-url-to-markdown)
...
- **baoyu-url-to-markdown**: Fetch Weibo URLs to Markdown. Install: `npx skills add jimliu/baoyu-skills --skill baoyu-url-to-markdown`.
