...
- Search source or crawler for 掘金 (Playwright/Firecrawl or baoyu-url-to-markdown)
...
- **baoyu-url-to-markdown**: Fetch Juejin URLs to Markdown. Install: `npx skills add jimliu/baoyu-skills --skill baoyu-url-to-markdown`.
