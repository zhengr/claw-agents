...
- 掘金搜索源或抓取方式（Playwright/Firecrawl 或 baoyu-url-to-markdown）
...
- **baoyu-url-to-markdown**：将掘金 URL 抓取为 Markdown。安装：`npx skills add jimliu/baoyu-skills --skill baoyu-url-to-markdown`。
